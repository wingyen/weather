...
var app = new Vue({
  ...
  methods: {
    ...
    changeBackground: function () {
      let sunny = "style/Jungle_Road.mp4";
      let rain = "style/rainy-day.mp4";
      let drizzle = "style/drizzle.mp4";
      let thunderstorm = "style/thunder.mp4";
      let snow = "style/snow-fall.mp4";
      let extreme = "style/extreme.mp4";
      let foggy = "style/foggy-ocean.mp4";
      let haze = "style/haze.mp4";
      let clouds = "style/clouds.mp4";
      let w = this.data.weather[0].main;
      ...
      $(document).ready(function () {
        switch (w) {
          ...
          case "Clouds":
            ...
            break;
          default:
            videoLink = "style/Up.mp4"
            break;
        }
        $("#myVideo").attr('src', videoLink)
      })
